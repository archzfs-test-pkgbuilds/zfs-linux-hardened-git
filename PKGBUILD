...
pkgver=2018.02.21.r3327.09302a4ca.4.15.4.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.02.21.r3327.09302a4ca" "linux-hardened=4.15.4.a-1")
