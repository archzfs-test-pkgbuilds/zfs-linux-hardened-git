...
pkgver=2018.03.31.r3398.10adee27c.4.15.12.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.03.31.r3398.10adee27c" "linux-hardened=4.15.12.a-1")
