...
pkgver=2018.02.27.r3340.3e9c9d8a8.4.15.6.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.02.27.r3340.3e9c9d8a8" "linux-hardened=4.15.6.a-1")
