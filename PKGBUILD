...
pkgver=2018.02.14.r3310.ddc751d56.4.15.2.a.1
pkgrel=1
makedepends=("linux-hardened-headers=4.15.2.a-1" "git" "spl-linux-hardened-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=ddc751d56beee8bf79d352ca3d8253d6238b2dc2")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.02.14.r3310.ddc751d56" "linux-hardened=4.15.2.a-1")
...
build() {
    ...
    ./configure --prefix=/usr --sysconfdir=/etc --sbindir=/usr/bin --libdir=/usr/lib \
                ...
                --with-linux=/usr/lib/modules/4.15.2-1-hardened/build \
                --with-linux-obj=/usr/lib/modules/4.15.2-1-hardened/build
    make
}
...
package_zfs-linux-hardened-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.15.2-1-hardened/Module.symvers
}
