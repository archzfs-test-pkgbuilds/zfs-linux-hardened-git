...
pkgver=2018.03.15.r3373.cec3a0a1b.4.15.9.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.03.15.r3373.cec3a0a1b" "linux-hardened=4.15.9.a-1")
