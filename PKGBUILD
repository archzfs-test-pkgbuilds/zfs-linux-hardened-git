...
pkgver=2018.01.25.r3257.cd0a89ded.4.14.15.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.01.25.r3257.cd0a89ded" "linux-hardened=4.14.15.a-1")
