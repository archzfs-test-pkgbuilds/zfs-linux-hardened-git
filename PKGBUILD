...
pkgver=2018.04.16.r3437.gd68ac65eb.4.15.17.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.04.16.r3437.gd68ac65eb" "linux-hardened=4.15.17.a-1")
