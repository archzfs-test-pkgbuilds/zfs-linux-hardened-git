...
pkgver=2018.04.11.r3417.gd22f3a824.4.15.15.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.04.11.r3417.gd22f3a824" "linux-hardened=4.15.15.a-1")
