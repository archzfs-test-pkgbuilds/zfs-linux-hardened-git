...
pkgver=2018.03.12.r3366.83362e8e6.4.15.9.a.1
pkgrel=1
makedepends=("linux-hardened-headers=4.15.9.a-1" "git" "spl-linux-hardened-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=83362e8e676a3ffae6b3b21f350f9b999a068605")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.03.12.r3366.83362e8e6" "linux-hardened=4.15.9.a-1")
...
package_zfs-linux-hardened-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.15.9-1-hardened/Module.symvers
}
