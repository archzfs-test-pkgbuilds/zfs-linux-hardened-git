...
pkgver=2018.03.28.r3389.d2812de6f.4.15.12.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.03.28.r3389.d2812de6f" "linux-hardened=4.15.12.a-1")
