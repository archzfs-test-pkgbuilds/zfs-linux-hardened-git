...
pkgver=2018.02.24.r3336.2a0428f16.4.15.6.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.02.24.r3336.2a0428f16" "linux-hardened=4.15.6.a-1")
