...
pkgver=2018.01.30.r3265.1d8a71b60.4.14.15.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.01.30.r3265.1d8a71b60" "linux-hardened=4.14.15.a-1")
