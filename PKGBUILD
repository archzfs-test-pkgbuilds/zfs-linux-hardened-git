...
pkgver=2018.03.28.r3390.13a2ff272.4.15.12.a.1
pkgrel=1
...
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-hardened-git" "zfs-utils-common-git=2018.03.28.r3390.13a2ff272" "linux-hardened=4.15.12.a-1")
